//! Strategy builder for constructing options strategies.

use rust_decimal::Decimal;
use serde::{Deserialize, Serialize};

use crate::options::{OptionContract, OptionStyle, OptionType};

use super::error::StrategyError;
use super::leg::{LegDirection, StrategyLeg};
use super::types::{OptionsStrategy, StrategyType};
