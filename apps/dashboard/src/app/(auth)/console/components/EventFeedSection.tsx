  ...
  return (
    <div className="bg-white dark:bg-night-800 rounded-lg border border-cream-200 dark:border-night-700 p-4">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-medium text-stone-900 dark:text-night-50">Event Feed</h2>
        <span className="text-sm text-stone-500 dark:text-night-300">{events.length} events</span>
      </div>
