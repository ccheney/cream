    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-night-800 rounded-lg border border-cream-200 dark:border-night-700">
        ...
        <div className="p-4">
          <p className="text-cream-400">
            Track investment theses and their performance over time
          </p>
      ...
      <div className="bg-white dark:bg-night-800 rounded-lg border border-cream-200 dark:border-night-700 p-4">
        ...
        <div className="text-sm text-cream-600 dark:text-cream-400 space-y-2">
          <p>• <strong>Core Idea:</strong> What is the investment thesis?</p>
          <p>• <strong>Catalyst:</strong> What will drive the price movement?</p>
          <p>• <strong>Time Horizon:</strong> When do we expect the thesis to play out?</p>
          <p>• <strong>Risk Factors:</strong> What could invalidate the thesis?</p>
          <p>• <strong>Position Sizing:</strong> How much capital to allocate?</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="border border-cream-200 dark:border-night-700 rounded-lg p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="font-mono font-medium text-cream-900 dark:text-cream-100">
            {symbol}
          </span>
        ...
        <div className="text-right">
          ...
          <div className="font-mono font-medium text-cream-900 dark:text-cream-100">
            {pnl}
          </div>
        </div>
      </div>
      <div className="mt-2 text-sm text-cream-600 dark:text-cream-400">
        {title}
      </div>
