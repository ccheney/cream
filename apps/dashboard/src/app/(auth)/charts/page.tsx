/**
 * Charts Page - Symbol Selector
 *
 * Landing page for charts view. Allows selecting an underlying symbol.
 */
...
export default function ChartsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold text-cream-800 dark:text-cream-100">Charts</h1>
      ...
      <form onSubmit={handleSearchSubmit}>
        <div className="relative">
          ...
          <button
            ...
            "
          >
            {isNavigating ? <Spinner size="sm" /> : "View Chart"}
          </button>
        </div>
      </form>
