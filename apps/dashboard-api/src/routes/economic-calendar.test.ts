...
describe("GET /economic-calendar - basic behavior", () => {
...
describe("GET /economic-calendar - range validation", () => {
...
describe("GET /economic-calendar - filtering and failures", () => {
...
describe("GET /economic-calendar - service responses", () => {
...
describe("GET /economic-calendar/:id", () => {
