 ...
 *
 * @module @cream/validation/service
 */

import type { ParityValidationResult, PerformanceMetrics, VersionRegistry } from "./parity.js";
...
export interface MetricsProvider {
  getBacktestMetrics(entityId: string): Promise<PerformanceMetrics | null>;
  getLiveMetrics(
    entityId: string,
    environment: ParityEnvironment
...
export class ParityValidationService {
  ...
  async validateIndicator(
    ...
    let backtestMetrics: PerformanceMetrics | undefined;
    let liveMetrics: PerformanceMetrics | undefined;
