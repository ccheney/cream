...
function withFREDCleanup(): void {
	afterEach(() => {
		resetFREDClient();
	});
}

function setEconomicCalendarSuccessClient(): void {
...
describe("getEconomicCalendar test mode", () => {
	withFREDCleanup();
...
describe("getEconomicCalendar no API key", () => {
	withFREDCleanup();
...
describe("getEconomicCalendar successful fetch API behavior", () => {
	withFREDCleanup();

	beforeEach(() => {
		setEconomicCalendarSuccessClient();
	});
...
describe("getEconomicCalendar successful fetch event mapping", () => {
	withFREDCleanup();
...
describe("getEconomicCalendar API error handling", () => {
	withFREDCleanup();
...
describe("getMacroIndicators test mode", () => {
	withFREDCleanup();
...
describe("getMacroIndicators no API key", () => {
	withFREDCleanup();
...
describe("getMacroIndicators successful fetch request behavior", () => {
	withFREDCleanup();
...
describe("getMacroIndicators successful fetch value mapping", () => {
	withFREDCleanup();
...
describe("getMacroIndicators missing latest value", () => {
	withFREDCleanup();
...
describe("getMacroIndicators invalid observations", () => {
	withFREDCleanup();
...
describe("getMacroIndicators API error handling", () => {
	withFREDCleanup();
