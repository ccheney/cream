...
describe("OptionsCalculatorAdapter basic functionality", () => {
...
describe("OptionsCalculatorAdapter null handling", () => {
...
describe("OptionsCalculatorAdapter unsupported fields", () => {
...
describe("OptionsCalculatorAdapter factory", () => {
...
describe("OptionsCalculatorAdapter concurrent provider calls", () => {
