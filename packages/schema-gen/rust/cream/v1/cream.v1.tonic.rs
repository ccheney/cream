...
/// Generated client implementations.
pub mod scanner_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
...
*/
    #[derive(Debug, Clone)]
    pub struct ScannerServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ScannerServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ScannerServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ScannerServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        ///
        pub async fn stream_scanner_alerts(
            &mut self,
            request: impl tonic::IntoRequest<super::StreamScannerAlertsRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::StreamScannerAlertsResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cream.v1.ScannerService/StreamScannerAlerts",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("cream.v1.ScannerService", "StreamScannerAlerts"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        ///
        pub async fn get_scanner_status(
            &mut self,
            request: impl tonic::IntoRequest<super::GetScannerStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetScannerStatusResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cream.v1.ScannerService/GetScannerStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cream.v1.ScannerService", "GetScannerStatus"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn reload_scanner_config(
            &mut self,
            request: impl tonic::IntoRequest<super::ReloadScannerConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReloadScannerConfigResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cream.v1.ScannerService/ReloadScannerConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("cream.v1.ScannerService", "ReloadScannerConfig"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod scanner_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ScannerServiceServer.
    #[async_trait]
    pub trait ScannerService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the StreamScannerAlerts method.
        type StreamScannerAlertsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::StreamScannerAlertsResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn stream_scanner_alerts(
            &self,
            request: tonic::Request<super::StreamScannerAlertsRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::StreamScannerAlertsStream>,
            tonic::Status,
        >;
        ///
        async fn get_scanner_status(
            &self,
            request: tonic::Request<super::GetScannerStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetScannerStatusResponse>,
            tonic::Status,
        >;
        ...
        async fn reload_scanner_config(
            &self,
            request: tonic::Request<super::ReloadScannerConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReloadScannerConfigResponse>,
            tonic::Status,
        >;
...
*/
    #[derive(Debug)]
    pub struct ScannerServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ScannerServiceServer<T>
    where
        T: ScannerService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cream.v1.ScannerService/StreamScannerAlerts" => {
                    #[allow(non_camel_case_types)]
                    struct StreamScannerAlertsSvc<T: ScannerService>(pub Arc<T>);
                    impl<
                        T: ScannerService,
                    > tonic::server::ServerStreamingService<
                        super::StreamScannerAlertsRequest,
                    > for StreamScannerAlertsSvc<T> {
                        type Response = super::StreamScannerAlertsResponse;
                        type ResponseStream = T::StreamScannerAlertsStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScannerService>::stream_scanner_alerts(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StreamScannerAlertsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/cream.v1.ScannerService/GetScannerStatus" => {
                    #[allow(non_camel_case_types)]
                    struct GetScannerStatusSvc<T: ScannerService>(pub Arc<T>);
                    impl<
                        T: ScannerService,
                    > tonic::server::UnaryService<super::GetScannerStatusRequest>
                    for GetScannerStatusSvc<T> {
                        type Response = super::GetScannerStatusResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScannerService>::get_scanner_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetScannerStatusSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/cream.v1.ScannerService/ReloadScannerConfig" => {
                    #[allow(non_camel_case_types)]
                    struct ReloadScannerConfigSvc<T: ScannerService>(pub Arc<T>);
                    impl<
                        T: ScannerService,
                    > tonic::server::UnaryService<super::ReloadScannerConfigRequest>
                    for ReloadScannerConfigSvc<T> {
                        type Response = super::ReloadScannerConfigResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScannerService>::reload_scanner_config(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReloadScannerConfigSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ScannerServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "cream.v1.ScannerService";
    impl<T> tonic::server::NamedService for ScannerServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
