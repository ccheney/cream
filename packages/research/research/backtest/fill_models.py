...
Based on specifications from docs/plans/12-backtest.md.
...
class SquareRootImpactSlippage(SlippageModel):
    ...
    def calculate(
        ...
        **kwargs,
        ...
        # Square-root impact: sigma * sqrt(Q/V)
        participation = size / adv
...
class TieredCommission(CommissionModel):
    ...
    def calculate(
        ...
        **kwargs,
        ...
        # Handle any remaining size above highest tier
...
class ZeroCommission(CommissionModel):
    ...
    def calculate(
        ...
        **_kwargs,
        ...
        # TAF and SEC fees only apply to sells
...
class FillModel:
    ...
    def to_vectorbt_params(
        ...
        **kwargs,
        ...
        """
        return {
            "fees": 0.0,  # We handle this through slippage
...
def create_institutional_fill_model(sigma: float = 0.02) -> FillModel:
    ...
    return FillModel(
        ...
        commission=TieredCommission(
            tiers=[
                (100, 0.01),  # First 100 shares: $0.01/share
                (1000, 0.007),  # 101-1000 shares: $0.007/share
                (10000, 0.005),  # 1001-10000 shares: $0.005/share
                (float("inf"), 0.003),  # 10001+ shares: $0.003/share
            ],
            minimum=1.0,
        ),
    )
