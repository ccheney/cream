...
const mockOptionContracts = {
  results: [
    {
      ticker: "AAPL260130C00150000",
...
const mockSnapshot = {
  ticker: "AAPL",
  day: { o: 150, h: 152, l: 149, c: 151, v: 5000000 },
  lastTrade: { p: 151.5, s: 100, t: Date.now() },
};

function createMockClient(): PolygonClient {
  return {
    getOptionContracts: mock(() => Promise.resolve(mockOptionContracts)),
    getTickerSnapshot: mock(() => Promise.resolve(mockSnapshot)),
