...
const INVALID_OSI_SYMBOLS = [
	...
	{ osi: "AAPL  261321C00180000", error: "INVALID_DATE" },
	{ osi: "AAPL  260032C00180000", error: "INVALID_DATE" },
	{ osi: "AAPL  260321X00180000", error: "INVALID_TYPE" },
	{ osi: "123456260321C00180000", error: "INVALID_SYMBOL" },
	{ osi: "aapl  260321C00180000", error: "INVALID_SYMBOL" },
] as const;
...
describe("parseOSI", () => {
	...
	test("handles unpadded symbols", () => {
		const result = parseOSI("AAPL260321C00180000");
		expect(result.success).toBe(true);
		if (result.success) {
