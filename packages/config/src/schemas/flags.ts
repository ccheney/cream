...
export const DEFAULT_FLAGS: FeatureFlag[] = [
  ...
  },
  {
    ...
    type: "boolean",
    default_value: false,
    environment_overrides: [{ environment: "BACKTEST", value: true }],
    allow_env_override: true,
    deprecated: false,
  },
  {
  ...
  },
  {
    ...
    type: "percentage",
    default_value: 0,
    environment_overrides: [{ environment: "LIVE", value: 10 }],
    allow_env_override: true,
    deprecated: false,
  },
  {
 ...
 */
export function mergeFlagsWithDefaults(userFlags: FeatureFlag[]): FeatureFlag[] {
