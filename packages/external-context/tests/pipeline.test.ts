...
const createDryRunPipeline = () =>
	createExtractionPipeline({
		extractionClient: mockExtractionClient,
		dryRun: true,
	});

describe("ExtractionPipeline Dry Run: Content", () => {
	const pipeline = createDryRunPipeline();
...
describe("ExtractionPipeline Dry Run: News", () => {
	const pipeline = createDryRunPipeline();
...
describe("ExtractionPipeline Configuration", () => {
...
describe("ExtractionPipeline Results", () => {
	const pipeline = createDryRunPipeline();
...
describe("ExtractionPipeline Source Type: News and Transcript", () => {
	const pipeline = createDryRunPipeline();
...
describe("ExtractionPipeline Source Type: Macro and Press Release", () => {
	const pipeline = createDryRunPipeline();
